        ...
        <div class="container">
            <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="col-xs-12 col-sm-6">
                    <a href="trang-chu">
                        <img src="public/images/LogoShop.png" style="width: 100%;" class="img-fix f-logo" alt="smart-construction">
                    </a>
                    <div class="about-store">
                        Shop Bún Bún Thơm ngon đến từng giọt cuối
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6">
                    <div class="f-contact">
                        ...
                        <ul class="list-unstyled">
                            <li class="clearfix">
                                ...
                                <span> Lê Quang Đạo, Nam Từ Liêm, Hà Nội</span>
                            </li>
                            <li class="clearfix">
                            ...
                            <li class="clearfix">
                                ...
                                <span><a href="mailto:vanhiepp1998@gmail.com">quangbinhbui023@gmail.com</a></span>
                            </li>
                        </ul>
                    </div>
                </div>
