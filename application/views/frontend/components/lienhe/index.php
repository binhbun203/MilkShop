			...
			">
				...
				<ul class="list-unstyled">
					<li class="clearfix">
						...
						<span style="color: black"> Lê Quang Đạo - Nam Từ Liêm - Hà Nội</span><br>
					</li>
					<li class="clearfix">
						<i class="fa fa-phone fa-1x" style="color:#0f9ed8;padding: 20px;  "></i>
						<span style="color: black">095678910</span>
					</li>
					<li class="clearfix">
						<i class="fa fa-envelope fa-1x " style="color:#0f9ed8; padding: 20px; "></i>
						<span style="color: black"><a href="mailto:sale.24hstore@gmail.com">quangbinhbui023@gmail.com</a></span>
					</li>
				</ul>
			</div>
